...
import { ArrowLeft, ArrowRight, Sparkles, CheckCircle, TrendingUp, AlertCircle, Award, ShieldAlert, Cpu, X } from 'lucide-react';
...
export const Scene4OptimizationStudio: React.FC<Scene4OptimizationStudioProps> = ({
  ...
  return (
    <div className="absolute top-20 left-8 right-8 bottom-24 z-20 pointer-events-none flex justify-between gap-6">
      ...
      <div className="w-full max-w-xl pointer-events-auto bg-white/94 backdrop-blur-xl p-6 rounded-3xl shadow-xl border border-[#DCE8EC] flex flex-col justify-between overflow-y-auto animate-in fade-in slide-in-from-left-4 duration-500">
      ...
      <div className="w-96 pointer-events-auto bg-white/94 backdrop-blur-xl p-5 rounded-3xl shadow-xl border border-[#DCE8EC] flex flex-col justify-between overflow-hidden animate-in fade-in slide-in-from-right-4 duration-500">
