    ...
    <div className="absolute top-24 left-8 max-w-lg z-20 pointer-events-auto">
      <div className="bg-white/92 backdrop-blur-xl p-6 rounded-3xl shadow-xl border border-[#DCE8EC] space-y-5 animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-[#087F8C] uppercase tracking-wider">
              Illustrative Electrode Cutaway
            </span>
        ...
        <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-1.5 text-xs font-semibold text-[#142A35]">
              ...
              <span>Illustrative Compaction</span>
            </div>
          ...
          <input
            aria-label="Illustrative compaction progress"
            type="range"
            min="0"
            max="1"
            step="0.01"
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span>Authored Endpoint (100%)</span>
          </div>
        ...
        <div className="p-3 rounded-2xl bg-slate-50 border border-slate-100 text-xs text-slate-600">
          <strong>Illustrative geometric progress: {(compression * 100).toFixed(0)}%</strong>
          <p className="mt-1">Authored particle motion, not measured thickness or porosity. No continuous physical relationship is inferred from this animation.</p>
        </div>
