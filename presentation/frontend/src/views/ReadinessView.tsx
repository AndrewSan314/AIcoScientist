    ...
    <div className="space-y-8 pb-16 animate-fadeIn">
      ...
      <header className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-red-50 border border-red-200 text-xs font-bold uppercase tracking-[0.18em] text-red-700 mb-2">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-red-200 bg-red-50 px-3.5 py-1.5 text-xs font-mono font-bold text-red-800">
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 flex flex-wrap gap-2 text-xs">
          ...
          <a href="#audit-disclaimer" className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-slate-600 hover:border-red-500 hover:text-red-700 transition">
            1. Scientific Invariant Definition
          </a>
          <a href="#boundaries" className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-slate-600 hover:border-red-500 hover:text-red-700 transition">
            2. Empirical Boundaries (2 Gates)
          </a>
          <a href="#matrix" className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-slate-600 hover:border-red-500 hover:text-red-700 transition">
            3. 50-Gate Verification Matrix
          </a>
          <a href="#governance" className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-slate-600 hover:border-red-500 hover:text-red-700 transition">
      ...
      <section id="audit-disclaimer" className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-xs">
        <div className="flex items-start gap-4">
          <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-red-600 text-xs font-black text-white shadow-xs">
            1
          </div>
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-red-50 border border-red-200 px-2 py-0.5 text-2xs font-semibold text-red-700">
                Audited Protocol
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-slate-50/70 hover:border-slate-300 transition space-y-3">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              <strong className="text-slate-900">Observation:</strong> Predictive interval coverage for refinement phase fraction reaches <strong className="text-red-700 font-mono">95.2%</strong> at the nominal 50% threshold, exceeding the nominal ±15% tolerance window.
            </p>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 truncate pr-2">
                  {isPass && <CheckCircle2 className="w-4 h-4 text-red-600 shrink-0" />}
      ...
      <section id="governance" className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-1">
            ...
            <div className="text-xl font-bold font-mono text-red-700">0 Violations</div>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-1">
            ...
            <div className="text-xl font-bold font-mono text-red-700">100% Pre-Reveal</div>
            <p className="text-slate-500 text-2xs leading-normal">
