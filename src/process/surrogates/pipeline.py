...
def run_pipeline(adapter: DatasetAdapter, output_dir: str | Path, config: PipelineConfig) -> dict[str, Any]:
    ...
    artifact.metrics = {"validation": validation_metrics, "test": test_metrics, "offline_ranking": offline, "residual_correction": "NOT_CONFIGURED"}; artifact_path = artifact.save(output / "surrogate.joblib")
