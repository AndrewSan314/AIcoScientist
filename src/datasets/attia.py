...
class AttiaAdapter(DatasetAdapter):
    ...
    def __init__(
        ...
        self._spec = DatasetSpec(
            ...
            pre_experiment_features=list(ATTIA_FEATURE_COLUMNS),
            post_experiment_characterization=[],
            targets=["simulated_lifetime"],
            constraints=["positive_c4_denom", "c4_bounds", "exclude_baseline"],
            candidate_variables=["C1", "C2", "C3"],
