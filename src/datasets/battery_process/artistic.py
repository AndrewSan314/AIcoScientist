...
class ArtisticSimulationAdapter(NormalizedRunAdapter):
    def metadata(self) -> BatteryDatasetMetadata:
        return BatteryDatasetMetadata(
            ...
            evidence_kind="SIMULATED_PHYSICS", source_doi="10.5281/zenodo.5956128", version="unverified", license="CC BY-NC-SA 4.0",
            ...
            limitations="Restricted source files; this is simulated evidence only.")
