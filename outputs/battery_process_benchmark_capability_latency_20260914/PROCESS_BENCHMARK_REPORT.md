...
- adaptive_evidence_policy: **IMPLEMENTED_NOT_VALIDATED** — Three pre-reveal evidence policies and blinded source-backed reveal are implemented and unit-tested; no source-backed policy-performance or EVI claim is made.

## Source-backed results

- Warwick ultrasound grouped holdout (48 rows/24 groups): gated R²=0.792; naive concatenation R²=0.943. Gated fusion is not superior on this split. Experimental cross-attention R²=0.940. Derived ultrasound-masking stress rates: 10%, 25%, 50%, 75%.
...
- Command: `scripts/run_battery_process_benchmark.py --output C:\Users\ADMIN\AppData\Local\Temp\aicoscientist-capability-latency-20260914 --allow-unavailable --replay-seeds 3 --replay-steps 2`
- Commit: `21a0648ef0d621827d602d2f919e3f40174cee10`
- Python: `3.14.2`
