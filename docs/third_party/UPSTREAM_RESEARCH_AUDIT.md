...
| [XRD-AutoAnalyzer](https://github.com/njszym/XRD-AutoAnalyzer) | `bf32082521e45c0fcf5cf9ae9bd1321e76bf9012` | MIT | None | NOT_AVAILABLE without model/reference configuration; descriptors are separate |
| [atomai](https://github.com/pycroscopy/atomai) | `93c88817a577686d6b8a84ab954872ca5cab7fcc` | MIT | None | Reference-only; no trained A-Lab weights or AtomAI invocation |
...
| [s4](https://github.com/CederGroupHub/s4) | `58691ce37bc0f659dac29804805c0538f284850b` | MIT | None | Reference-only; current adapter is not S4 |
...
The A-Lab replay source is [A-Lab Precursor Genome](https://github.com/lauren-walters/precursor-genome), DOI [10.5281/zenodo.21285546](https://doi.org/10.5281/zenodo.21285546), licensed CC BY 4.0. It is separate from AmanchukwuLab's `AL-anode-free` electrolyte dataset. Only canonical sample-linked XRD/refinement/outcome records enter replay; precursor-level SEM/EDS archives remain inventory-only.
